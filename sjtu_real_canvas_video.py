...
def get_real_canvas_videos_using_sub_cookies(sub_cookies):
    return [
        [
            requests.post(
...
def get_real_canvas_videos(course_id, oc_cookies):
    sub_cookies = get_sub_cookies(course_id, oc_cookies)
    return get_real_canvas_videos_using_sub_cookies(sub_cookies)
